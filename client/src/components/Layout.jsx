...
const s = {
  ...
  logo:     { color:'#fff', fontWeight:800, fontSize:16, letterSpacing:'-0.2px', lineHeight:1.2 },
  sub:      { color:'rgba(255,255,255,0.55)', fontSize:11, fontWeight:400, marginTop:2 },
  ...
  return (
    <div style={s.shell}>
      <header style={s.header}>
        {/* Branding — #11 */}
        <div>
          <div style={s.logo}>Adani Defence &amp; Aerospace Knowledge Hub</div>
          <div style={s.sub}>Talent Intelligence Platform · AEW&amp;C Mk-II</div>
        </div>
        ...
        {/* User chip — #13: no duplicate role, show name + Admin/Member */}
        <div style={s.userChip} ref={menuRef}>
          ...
          {menuOpen && (
            <div style={{ position:'absolute', top:46, right:0, background:'#fff', borderRadius:10, boxShadow:'0 8px 32px rgba(0,0,0,0.18)', border:'1px solid #E2E8F0', minWidth:190, zIndex:999, overflow:'hidden' }}>
              <div style={{ padding:'10px 14px 8px', borderBottom:'1px solid #F1F5F9' }}>
                ...
                <div style={{ fontSize:10, fontWeight:700, textTransform:'uppercase', letterSpacing:0.5, color:'#00259C', marginTop:3 }}>{user?.role}</div>
              </div>
              <button
